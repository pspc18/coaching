...
|
*/
Route::match(['get','post'],'/webhook/attendance', [AttendanceWebhookController::class, 'sync']);
Route::get('/app-version', [DownloadController::class, 'getVersion']);
...
Route::match(['get', 'post'], 'saveDeviceToken', 'Api\UserController@saveDeviceToken');
