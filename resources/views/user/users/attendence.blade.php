        ...
        <div class="row">
          <div class="col-12 col-md-12">
            <div class="card card-outline card-orange">
                    ...
                    <a href="{{url('staff_attendance_add')}}" class="btn btn-primary  btn-sm {{ Helper::permissioncheck(6)->add ? '' : 'd-none' }}" ><i class="fa fa-plus"></i> <span class="Display_none_mobile">{{ __('common.Add') }} </span> </a>
