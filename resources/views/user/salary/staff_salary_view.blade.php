              ...
              @if(!empty($data))
                ...
                <tr>
						...
						<td> 
						    ...
						    <a href="{{ url('salary_print') }}/{{ $item->staff_id }}/{{ $item->month_id }}" target="blank" class="btn btn-xs btn-primary btn-xs ml-3 tooltip1" title1="Print"><i class="fa fa-print"></i></a>  
                        </td>
