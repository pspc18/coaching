...
<style>
/* ==========================================================================
   ARISE ERP - ADD VISITOR (FULL-SCREEN VIEWPORT UTILIZATION)
...
<div class="content-wrapper visitor-form-wrapper">
    <div class="visitor-form-container">
        ...
        <div class="visitor-hero">
            <div class="visitor-hero-text">
                ...
                <h1 class="visitor-title">
                    <i class="fa fa-user-plus text-info"></i> Add New Visitor
                </h1>
                <p class="visitor-subtitle">Register visitor entry, tag linked student, record identification &amp; log purpose of visit</p>
            </div>
        ...
        {{-- Form Root --}}
        <form action="{{ url('visitorAdd') }}" method="post" id="visitorAddForm" class="visitor-form-root">
            @csrf
                                        ...
                                        <div class="form-group-compact">
                                            ...
                                            <div class="input-action-group">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       value="{{ old('id_name', 'Aadhaar Card') }}"
                                                       list="idTypeList">
                        ...
                        <div class="visitor-card-body">
                            ...
                            <div class="form-group-compact d-flex flex-column flex-grow-1 mt-1">
                                ...
                                <textarea class="form-control flex-grow-1" 
                                          id="remark" 
                                          name="remark" 
                                          placeholder="Enter purpose of visit (e.g. Admission inquiry, Fee payment, Meet Class Teacher, Document Submission)...">{{ old('remark') }}</textarea>
                            </div>
            ...
            <div class="form-submit-bar">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <button type="submit" class="btn-submit-save" id="btnSubmitVisitor">
                        <i class="fa fa-check-circle mr-1"></i> Save Visitor Entry
                    </button>
                </div>
            </div>
...
$(document).ready(function() {
    $('#visitorAddForm').on('submit', function() {
        const btn = $('#btnSubmitVisitor');
        btn.prop('disabled', true);
        btn.html('<i class="fa fa-spinner fa-spin mr-1"></i> Saving Entry...');
    });
});
</script>
@endsection
