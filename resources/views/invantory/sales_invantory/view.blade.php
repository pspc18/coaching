                                        ...
                                        @if(!empty($data))
                                            ...
                                            @foreach ($data  as $item)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('sales_invantory_edit') }}/{{ $item['id'] ?? '' }}" class="btn btn-primary  btn-xs tooltip1" title1='Edit'  ><i class="fa fa-edit"></i></a>
                                                        <a href="javascript:;" data-id='{{$item['id'] }}' data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData btn btn-danger btn-xs ml-3 tooltip1" title1='Dlete'><i class="fa fa-trash-o"></i></a>
                                                        <a href="{{ url('sale_inventory_print') }}/{{ $item['id'] ?? '' }}" class="btn btn-primary  btn-xs tooltip1" title1='Print' ><i class="fa fa-print"></i></a></td>
                                                </tr>    
                                            @endforeach
                                        @endif
                                    </tbody>
