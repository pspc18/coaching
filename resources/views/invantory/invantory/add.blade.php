...
<div class="content-wrapper">
   ...
   <section class="content pt-3">
    ...
    <div class="card card-outline card-orange">
            ...
            <form id="form-submit" action="{{ url('invantory_add') }}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="row m-2">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <span class="input-group-append">
                                <input id="party_name1" type="text" class="form-control"  name="party_name"  value="{{old('party_name') ?? ''}}" placeholder="Party Name" style="height: 35px;" >
...
-->                      <th>Total Amount</th>
                  ...
                  <tbody id ="tbodynew">
                    ...
                    <td style="width: 240px;">
                        <div class="form-group">
                            <input id="item_name_0" type="text" class="form-control item_name" name="item_name[]"  value="{{old('item_name')}}" placeholder="item Name" >
                    ...
                    <td>
                        <div class="form-group" style="width: 8pc;">
                            <input name="qty[]" id="qty_0" placeholder="Quantity" class="form-control qty"  onblur="calcSum(this.value,0)" maxlength="100" type="text"  value="{{ old('quantity') }}" onkeypress="javascript:return isNumber(event)">
                	   </div>
                    </td>
                   <td>
                        <div class="form-group">
                    ...
                    <td>
                        <div class="form-group" style="width: 8pc;">
                            <input name="tax[]" id="tax_0" placeholder="Tax" class="form-control tax"  onblur="calcSum(this.value,0)" maxlength="100" type="text"  value="{{ old('tax') }}" onkeypress="javascript:return isNumber(event)">
                	   </div>
                    </td>
                  <!--  <td>
                        <div class="form-group" style="width: 8pc;">
	...
	<input type="hidden" name="value_room" id="value_room" value="1">
            ...
            <div class="col-md-2">
                <div class="form-group">
					...
					<input type="text" class="form-control" id="Quantity" tabindex="1" readonly placeholder="Total Quantity" name="total_qty"   value="">
				</div>
			</div>
			<div class="col-md-2">
                <div class="form-group">
					 <label for="netamount_amt">Net Amount</label>
					<input type="text" class="form-control" id="net_amount" readonly tabindex="1" placeholder="Net Amount" name="net_amount">
				</div>
			</div>
