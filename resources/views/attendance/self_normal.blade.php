        ...
        <div class="container-fluid">
            <div class="attendance-shell">
                <div class="attendance-hero">
                    <div class="attendance-hero-inner">
                        <div>
                            ...
                            <p class="attendance-hero-subtitle">Mark your own attendance quickly with the same process, now arranged for mobile-app style usage.</p>
                        </div>
                ...
                <div class="attendance-stat-grid">
                    ...
                    <div class="attendance-stat"><span class="label">Current Status</span><strong>{{ ucfirst((string) ($mark->status ?? 'Pending')) }}</strong></div>
                    <div class="attendance-stat"><span class="label">Mode</span><strong>Normal</strong></div>
                    <div class="attendance-stat"><span class="label">Action</span><strong>Ready</strong></div>
                </div>
                ...
                <div class="card card-outline card-orange self-card">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h3 class="card-title mb-0"><i class="fa fa-user"></i> &nbsp;Self Attendance (Normal)</h3>
