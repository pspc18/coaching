...
<table style="border-bottom: 0px solid;width:100%;" >
	...
	<tr>
      <td class="border_none" rowspan='1' colspan="12"width='20%'>
          <img  rowspan="4" src="{{ env('IMAGE_SHOW_PATH').'setting/left_logo/'.$getSetting['left_logo'] ?? '' }}" style="width: 97px;">
          
          </td>
          <td style="text-align:center; border: none"><span class="style71"><strong style="font-size: 30px">{{$getSetting['name'] ?? ''}}</strong></span>
...
<!--	<tr style="text-align:center;">
    ...
    <table>
        ...
        <tr>
            <th style="text-align: center;"><b>Receipt No.: <span style='color:red' >{{$data[0]['receipt_no'] ?? ''}}</span></b>
        ...
        <tr>
            <th style="text-align: center;"><b>Offline Receipt No.: <span style='color:red' >{{$data[0]['offline_receipt_no'] ?? ''}}</span></b>
            ...
            <tr>
                <td >
                    @php
                        ...
                        $fees_assignment = DB::table('fees_assign_details')
                ...
                <td>{{ !empty(optional($fees_assignment)->installment_due_date) && strtotime($fees_assignment->installment_due_date) !== false ? date('d-M-Y', strtotime($fees_assignment->installment_due_date)) : '' }}</td>
                <td>{{ number_format($fees_assignment->fees_group_amount ?? 0, 2) }}</td>
