            ...
            <div class="card card-outline card-orange">
				<div class="card-header bg-primary flex_items_toggel">
					...
					<div class="card-tools">
					     ...
					     <a href="{{url('teachers/add')}}" class="btn btn-primary  btn-sm {{ Helper::permissioncheck(2)->add ? '' : 'd-none' }}" title="Add Teacher"><i class="fa fa-plus"></i> <span class="Display_none_mobile">{{ __('common.Add') }} </span> </a> 
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               @if(isset($item->class_type_id) && !empty($item->class_type_id))
                                    @php
                                        // Split comma-separated class type IDs
                                        $classIds = explode(',', $item->class_type_id);
                                
                                        // Fetch class type names by ID
                            ...
                            @if(Session::get('role_id') !=  3 && Session::get('role_id') !=  2 ) 
                                ...
                                <!--<td>{{ $item['joining_date']  }}</td>-->
                                      ...
                                      <a href="{{url('joining_letter_print')}}/{{$item->id}}" target="blank" class="{{ Helper::permissioncheck(2)->print ? '' : 'd-none' }}"><li class="dropdown-item text-success" title="Joining print"><i class="fa fa-print text-success"></i>{{ __('staff.Joining print') }}</li></a>
                                        <a href="{{url('teachers_idCard')}}/{{$item->id}}" target="blank" class="{{ Helper::permissioncheck(2)->print ? '' : 'd-none' }}"><li class="dropdown-item text-success" title="Id Card"><i class="fa fa-print text-success"></i>{{ __('Id Print') }}</li></a>
                                    <a class="{{ Helper::permissioncheck(2)->edit ? '' : 'd-none' }}" href="{{url('teachers/edit',$item->id)}}"><li class="dropdown-item text-primary" title="Edit"><i class="fa fa-edit text-primary"></i> {{ __('common.Edit') }}</li></a>
                                   
                                   
                                        <a href="javascript:;"  data-id='{{$item->id}}' data-bs-toggle="modal" data-bs-target="#Modal_id"  class="deleteData {{ Helper::permissioncheck(2)->delete ? '' : 'd-none' }}"><li class="dropdown-item text-danger" title="Delete"><i class="fa fa-trash-o text-danger"></i> {{ __('common.Delete') }}</li></a>                                 
                                        </ul>
